...
namespace UnityEngine.UI.Extensions
{
    ...
    public class UI_ScrollRectOcclusion : MonoBehaviour
    {
        ...
        [HideInInspector] public bool _initialised = false;
        ...
        void ToggleGridComponents(bool toggle)
        {
            ...
            if (_isHorizontal)
                _disableMarginX = (_scrollRect.GetComponent<RectTransform>().rect.width / 2) - (_items.Count > 0 ? _items[0].sizeDelta.x /2 : 0);// +;
